...
export default function BoardPostDetailPage() {
  ...
  const loadPost = async () => {
    ...
    try {
      ...
      const text = error instanceof Error ? error.message : "게시글을 불러오지 못했습니다."
      setMessage(text)
      setPost(null)
    } finally {
  ...
  const loadComments = async (reset: boolean) => {
    ...
    try {
      ...
      const text = error instanceof Error ? error.message : "댓글을 불러오지 못했습니다."
      setMessage(text)
    } finally {
  ...
  const handleSaveComment = async (commentId: number) => {
    ...
    try {
      ...
      const text = error instanceof Error ? error.message : "댓글 수정에 실패했습니다."
      setMessage(text)
    } finally {
  ...
  const handleDeleteComment = async (commentId: number) => {
    ...
    try {
      ...
      const text = error instanceof Error ? error.message : "댓글 삭제에 실패했습니다."
      setMessage(text)
    } finally {
